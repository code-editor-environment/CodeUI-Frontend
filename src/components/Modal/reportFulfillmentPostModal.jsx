...
import { ReportFulfillment } from "../../api/element";
import { toast } from "react-toastify";
import { useNavigate } from 'react-router-dom';
function ReportFulfillmentPostModal({ id }) {
  const reasons = [
    {
  ...
  const submit = () => {
    ReportFulfillment({ id }).then((data) => {
      if (data.errorCode) {
...
export default ReportFulfillmentPostModal;
