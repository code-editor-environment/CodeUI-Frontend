...
import universe from "../../../../assets/media/q-c3d7becf.webm";
import { Link } from "react-router-dom";
import styles from "./hero.module.scss";
function HeroTest() {
  const renderStar = () => {
    const num = Array.from({ length: 100 }, (_, index) => index);
    return (
      <div className={styles.stars}>
        {num.map((index) => (
          <div className={styles[`star${index}`]} key={index} />
        ))}
      </div>
    );
  };
    ...
    <section className={styles.hero}>
      <div className={styles.heroContent}>
        <div className={styles.sectionHeader}>
          <h1>
            <div>
              <span>Celebrating the Artistry of Creative Coders</span>
            </div>
          </h1>
        </div>
      ...
      <div className={styles.heroBlackHole}>
