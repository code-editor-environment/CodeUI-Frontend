...
function Stat() {
  ...
  return (
    <div className="flex z-[1] py-24 px-6 pt-20 items-center justify-center flex-wrap gap-10 relative overflow-hidden">
      ...
      >
        <div
          className="aspect-[1154/678] w-[72.125rem] bg-gradient-to-br from-fuchsia-400 to-indigo-400"
          style={{
            clipPath:
      ...
      <div className="text-center max-w-[200px] flex flex-col items-center">
        <svg
          ...
          strokeWidth={2}
        >
          <path d="M3 6.2c0-1.12 0-1.68.218-2.108a2 2 0 0 1 .874-.874C4.52 3 5.08 3 6.2 3h.6c1.12 0 1.68 0 2.108.218a2 2 0 0 1 .874.874C10 4.52 10 5.08 10 6.2v2.6c0 1.12 0 1.68-.218 2.108a2 2 0 0 1-.874.874C8.48 12 7.92 12 6.8 12h-.6c-1.12 0-1.68 0-2.108-.218a2 2 0 0 1-.874-.874C3 10.48 3 9.92 3 8.8V6.2Z" />
          <path d="M3 18.5c0-.465 0-.697.038-.89a2 2 0 0 1 1.572-1.572C4.803 16 5.035 16 5.5 16h2c.465 0 .697 0 .89.038a2 2 0 0 1 1.572 1.572c.038.193.038.425.038.89s0 .697-.038.89a2 2 0 0 1-1.572 1.572C8.197 21 7.965 21 7.5 21h-2c-.465 0-.697 0-.89-.038a2 2 0 0 1-1.572-1.572C3 19.197 3 18.965 3 18.5Z" />
          <path d="M14 5.5c0-.465 0-.697.038-.89a2 2 0 0 1 1.572-1.572C15.803 3 16.035 3 16.5 3h2c.465 0 .697 0 .89.038a2 2 0 0 1 1.572 1.572c.038.193.038.425.038.89s0 .697-.038.89a2 2 0 0 1-1.572 1.572C19.197 8 18.965 8 18.5 8h-2c-.465 0-.697 0-.89-.038a2 2 0 0 1-1.572-1.572C14 6.197 14 5.965 14 5.5Z" />
